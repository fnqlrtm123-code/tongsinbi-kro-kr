...
export default function FaqSection({ limit }: { limit?: number }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Bottom CTA Banner */}
      <div className="bg-blue-600 text-white rounded-xl p-5 flex flex-col sm:flex-row justify-between items-center gap-4 shadow-sm">
        <div className="space-y-1 text-center sm:text-left">
          <p className="text-xs font-bold text-blue-100">소멸시효 5년 지나기 전에 즉시 확인하세요</p>
        ...
        <a
          ...
          className="px-5 py-3 bg-white hover:bg-blue-50 text-blue-700 font-black text-xs sm:text-sm rounded-lg transition-transform hover:scale-105 shrink-0 shadow-sm flex items-center gap-1.5"
        >
